...
public class Level_3 extends ScreenAdapter {
    World world;
    AngryBirdGame game;
    ...
    private static final float SETTLING_TIME = 1f;

    private int state;

    public Level_3(AngryBirdGame game , int state) {
        this.game = game;
        this.state= state;
    }
    ...
    private void jatinkagharbanado()
    {
        String kaddu = "level3_state.txt";
        if(state == -1) {
            kaddu = "level3_savestate.txt";
        }


        FileHandle fileHandle = Gdx.files.internal(kaddu);
        ...
        if (fileHandle.exists()) {
            ...
            System.out.println("Level state file not found: " + kaddu);
        }
        ...
        private ContactListener createContactListener ()
        {
            return new ContactListener() {
                ...
                public void beginContact(Contact contact) {
                    ...
                    handleCollision(userDataA);
                    handleCollision(userDataB);

                    if (birdusing != null && (bodyA == birdusing.getBody() || bodyB == birdusing.getBody())) {
                        isSettling = true;
                        settlingTimer = 0;
                    }
                }
        ...
        private void ta_behtja (Bird bird)
        {
...
nikalbc();
        ...
        private void saveGameStateToFile () throws IOException
        {
            ...
            String fileName = "level3_savestate.txt";
