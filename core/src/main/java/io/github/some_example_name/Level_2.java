...
public class Level_2 extends ScreenAdapter
{
    World world;
    AngryBirdGame game;
    ...
    public Level_2(AngryBirdGame game , int state)
    {
        this.game = game;
        this.state = state;
    }
    ...
    private void meraghar()
    {
        String jaat = "level2_state.txt";
        if(state == -1)
        {
            jaat = "level2_savestate.txt";
        }


        FileHandle fileHandle = Gdx.files.internal(jaat);
        ...
        {
            System.out.println("Level state file not found: " + jaat);
        }
    ...
    private void kabutarbethja(Bird bird)
    {
    ...
    {
        String fileName = "level2_savestate.txt";
