...
//here is the implementation of level1 of our game
public class Level_1 extends ScreenAdapter
{
    ...
    public Level_1(AngryBirdGame game,int state)
    {
        this.game = game;
        this.state = state;
    }
    ...
    //creates different bodies , tetures s[rties etc
    ...
    //first method runned when thos creen os set. here we give textures to all things
    @Override
    public void show()
    {
    ...
    //here we create a ground type structure that is present below and do not let any other body cross it
    private void jameen()
    {
    ...
    //similar to above but change in position,, present at the right corner
    ...
    {
        String udta_panjab = "level1_state.txt";

        if(state == -1)
        {
            udta_panjab = "level1_savestate.txt";
        }
    ...
    //this is invoked when collision happens , reduction of health points etc
    ...
    //tocheck whether bird has moved out of world
    ...
    private void saveGameStateToFile() throws IOException
    {
        ...
        String fileName = "level1_savestate.txt";
        print("game is save to file");
